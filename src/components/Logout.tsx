  ...
  return (
    <div className="text-center flex bg-white m-4 py-8 rounded-2xl justify-center items-center flex-col px-16">
      ...
      <div className="flex justify-center gap-4">
        <button
          onClick={onCancel}
          className="border-purple-700 cursor-pointer my-4 font-bold border bg-white text-purple-700 px-10 py-2 rounded-md"
        >
          Cancel
        </button>
        <button
          onClick={onConfirm}
          className="text-white cursor-pointer font-bold bg-purple-700 px-10 my-4 py-2 rounded-md"
        >
          Logout
        </button>
      </div>
